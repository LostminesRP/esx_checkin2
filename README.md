# esx_checkin
This is my first ever script, so it's bad coded. The optimization could also be better, but it's fine. So please don't be to harsh on me, although, both negative and positive feedback is extremely helpful and appreciated.
